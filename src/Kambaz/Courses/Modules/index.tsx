export default function Modules() {
    return (
      <div>
        <button>Collapse All</button> <button>View Progress</button> <select id="wd-select-publishing">
   <option value="PUBLISHALL">Publish all</option>
   <option value="PUBLISHMODULES">Publish modules only</option>
   <option selected value="UNPUBLISHALL">
       Unpublish all modules and items</option>
   <option value="UNPUBLISHMODULES">Unpublish modules only</option>
